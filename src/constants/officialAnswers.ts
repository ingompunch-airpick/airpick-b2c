...
export const SHORT_ANSWERS = {
  ...
  cancel: '입고 24시간 전이면 예약 탭에서 무료 취소할 수 있습니다. 그 이후·입고 후는 업체에 문의하세요.',
  ...
  esimBuy: '아니요. 제휴 할인 링크로 이동해, 제휴사에서 구매·개통합니다.',
  esimType: '최신폰 eSIM 지원이면 이심(eSIM), 아니면 실물 유심을 고르세요.',
  esimPrice: '할인은 제휴사 사이트 기준입니다. 결제 전 최종 금액을 확인하세요.',
  leaveBy:
    '홈에서 맡기는·찾는 일정을 넣은 뒤 집 주소를 넣으면, 차 맡기기 시각 기준 추천 출발 시각을 안내합니다.',
  leaveByBuffer:
    '차 맡기기(공항 도착) 시각과 이동 시간을 반영한 여유 계획용이며, 실시간 혼잡 API가 아닙니다.',
  longLotVsValet:
    '장기주차는 공항 이동(셔틀 등)을 반영하고, 주차대행은 업체별 방식이 달라 계산에 넣지 않습니다.',
} as const;
...
export const VOICE_BRAND_BLURB =
  '에어픽 주차대행 비교센터(에어픽)는 인천공항 출국시간 계산, 주차대행 비교, 이심 제휴 할인 플랫폼입니다. 고객센터는 공일공 이오오육 오칠사육, 아홉시부터 열여덟시까지입니다.';
