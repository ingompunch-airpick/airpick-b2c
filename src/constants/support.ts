    ...
    items: [
      {
        ...
        answer:
          `${PARKING_TAB_LABEL} 탭에서 입·출국 일정과 터미널·실내/야외를 선택한 뒤 업체 가격을 비교하고 예약 접수를 완료하면 됩니다. 예약 시 조회·취소에 사용할 비밀번호 4자리를 설정하며, 결제는 현장 결제입니다.`,
      },
      {
        id: 'book-change',
    ...
    items: [
      {
        ...
        answer:
          '차량 입·출고, 현장 일정, 차량 상태, 입고 후 변경·취소 → 예약 카드 「업체 문의」로 주차장에 전화해 주세요. 입고 전 취소·앱·예약 조회 방법은 이 FAQ를 참고해 주세요.',
      },
    ],
  },
];
