...
export const ESIM_FAQ_CATEGORY: FaqCategory = {
  ...
  items: [
    ...
    {
      id: 'esim-diff',
      question: '이심(eSIM)과 USIM 중 무엇을 선택해야 하나요?',
      shortAnswer: SHORT_ANSWERS.esimType,
      answer:
        '이심(eSIM)을 지원하는 최신 스마트폰이면 eSIM이 편합니다(물리 카드 없이 QR 설치). eSIM 미지원 기기는 USIM을 선택해 주세요.',
    },
    {
      id: 'esim-price',
    ...
    {
      id: 'esim-support',
      question: '이심(eSIM) 개통이 안 되거나 데이터가 안 될 때는?',
      shortAnswer:
