...
export default function SiteFooter({ onOpenPrivacy }: { onOpenPrivacy?: () => void }) {
    ...
    <footer className="mt-6 border-t border-sky-border/60 px-1 pt-4 pb-2">
      ...
      <dl className="mt-1.5 space-y-0.5 text-[10px] font-medium leading-relaxed text-muted-light">
        ...
        <div className="flex gap-1.5">
          ...
          <dd>
            <a href={`mailto:${COMPANY_LEGAL.email}`} className="text-brand underline-offset-2 hover:underline">
              {COMPANY_LEGAL.email}
            </a>
          </dd>
        </div>
